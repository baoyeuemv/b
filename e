...
function TP2(P1)
    ...
    function Text(value)
		game.StarterGui:SetCore("SendNotification", {
			...
			Text = tostring(value),
			Icon = "http://www.roblox.com/asset/?id=15699625509",
			Duration = 10
		})
	end
...
SOMEXHUBMODILE.Name = "SOMEXHUBMODILE"
        ...
        MODILEMAGE.Image = "http://www.roblox.com/asset/?id=15699625509"
...
local LogoHub = Instance.new("ImageLabel")
	...
	LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(15699625509)
...
local LogoToggle = Instance.new("ImageLabel")
	...
	LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(15699625509)
